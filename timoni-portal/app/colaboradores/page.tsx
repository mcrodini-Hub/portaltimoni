...
export default async function ColaboradoresPage(){
 ...
 {panelStore==="geral"?<section className="grid items-start gap-4 lg:grid-cols-2"><AnnouncementCard store="rio claro" isAdmin={isCica}/><AnnouncementCard store="araras" isAdmin={isCica}/><div className="lg:col-span-2"><MeetingSummaryCard araras={araras} rioClaro={rioClaro}/></div><EventCard title="Aniversários" tone="pink" events={birthdays}/><EventCard title="Férias" tone="amber" events={vacations}/></section>:<section className="grid items-start gap-4 lg:grid-cols-2"><AnnouncementCard store={panelStore} isAdmin={isCica}/><MeetingSummaryCard araras={panelStore==="araras"?araras:[]} rioClaro={panelStore==="rio claro"?rioClaro:[]}/><EventCard title="Aniversários" tone="pink" events={birthdays}/><EventCard title="Férias" tone="amber" events={vacations}/></section>}
