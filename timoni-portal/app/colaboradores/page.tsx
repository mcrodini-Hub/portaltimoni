...
export default async function ColaboradoresPage(){
 ...
 {panelStore==="geral"?<section className="grid gap-4 lg:grid-cols-3"><div className="space-y-4"><AnnouncementCard store="rio claro" isAdmin={isCica}/><EventCard title="Aniversários" tone="pink" events={birthdays}/></div><div className="space-y-4"><AnnouncementCard store="araras" isAdmin={isCica}/><EventCard title="Férias" tone="amber" events={vacations}/></div><MeetingSummaryCard araras={araras} rioClaro={rioClaro}/></section>:<section className="grid gap-4 lg:grid-cols-2"><AnnouncementCard store={panelStore} isAdmin={isCica}/><MeetingSummaryCard araras={panelStore==="araras"?araras:[]} rioClaro={panelStore==="rio claro"?rioClaro:[]}/><EventCard title="Aniversários" tone="pink" events={birthdays}/><EventCard title="Férias" tone="amber" events={vacations}/></section>}
