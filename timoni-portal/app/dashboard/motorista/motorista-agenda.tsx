...
export default function MotoristaAgenda() {
  ...
  async function salvar(event: FormEvent) {
    ...
    try {
      ...
      const linkMaps = form.linkEndereco || `https://maps.google.com/?q=${encodeURIComponent(enderecoCompleto)}`;
