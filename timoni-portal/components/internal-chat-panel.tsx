          ...
          <div className="flex-1 overflow-y-auto p-2">
            ...
            {filteredContacts.map((item) => {
              ...
              return (
                ...
                >
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#2296E8] text-sm font-semibold text-white">{item.name.slice(0, 2).toUpperCase()}</span>
