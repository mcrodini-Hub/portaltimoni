...
const modules: Array<{
  ...
  { module: "motorista", name: "Agendamento do Motorista", description: "Cadastro, edição e organização de entregas, retiradas e viagens.", href: "/agenda-motorista-v2/", icon: "🚚", accent: "border-amber-200 bg-amber-50" },
