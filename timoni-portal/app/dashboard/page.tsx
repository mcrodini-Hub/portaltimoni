...
const modules: Array<{
  ...
  { module: "motorista", name: "Motorista", description: "Cadastro e organização de entregas, retiradas e bloqueios de horário.", href: "/dashboard/motorista", icon: "🚚", accent: "border-amber-200 bg-amber-50" },
