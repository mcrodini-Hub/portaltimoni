  ...
  return (
    <div className="pb-10">
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
              Consulta de produtos, solicitações, central de necessidades e respostas do estoque para Rio Claro e Araras.
            </p>
          </div>
      ...
      <section className="mt-5 grid gap-4 md:grid-cols-3">
        {[
          ["Ciça", "Acesso total: necessidades, solicitações e produtos."],
          ["Estoque", "Lucas, Jeovana e Reinaldo consultam produtos e respondem às necessidades."],
