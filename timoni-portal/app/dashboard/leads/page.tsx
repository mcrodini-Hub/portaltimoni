...
export default function LeadsPage() {
  ...
  return <div className="pb-8">
    ...
    {importError&&<div className="mb-4 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">{importError}</div>}
