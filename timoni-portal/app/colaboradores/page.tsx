...
export default async function ColaboradoresPage(){
 ...
 {panelStore==="geral"?<section className="grid items-start gap-4 lg:grid-cols-2"><AnnouncementCard store="rio claro" isAdmin={isCica}/><AnnouncementCard store="araras" isAdmin={isCica}/><MeetingSummaryCard title="Rio Claro" list={rioClaro}/><MeetingSummaryCard title="Araras" list={araras}/><EventCard title="Aniversários" tone="pink" events={birthdays}/><EventCard title="Férias" tone="amber" events={vacations}/></section>:<section className="grid items-start gap-4 lg:grid-cols-2"><AnnouncementCard store={panelStore} isAdmin={isCica}/><MeetingSummaryCard title={panelStore==="araras"?"Araras":"Rio Claro"} list={panelStore==="araras"?araras:rioClaro}/><EventCard title="Aniversários" tone="pink" events={birthdays}/><EventCard title="Férias" tone="amber" events={vacations}/></section>}
