...
3. Configure a **Tela de consentimento OAuth** ("OAuth consent screen"):
   ...
   - Nome do app: "Portal Timoni". Email de suporte/contato:
     `mcrodini@gmail.com`.
...
## 6. Ligar ao Portal Timoni (opcional)

O [Portal Timoni](../painel-timoni/README.md) é uma página estática pessoal que mostra um
...
4. No Portal Timoni, abra **⚙ Planilhas** e preencha "Agenda Ciça" com a URL do portal
...
se o card do Portal Timoni passar a mostrar erro, repita os passos 2-3 para gerar um novo.
...
│       └── public/agenda-resumo/  # resumo de hoje para o Portal Timoni (token, sem login)
├── lib/
