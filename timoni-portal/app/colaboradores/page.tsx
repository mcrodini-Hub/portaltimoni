...
export default async function ColaboradoresPage(){
 ...
 {panelStore==="geral"?<section className="grid gap-4 lg:grid-cols-3"><div className="space-y-4"><AnnouncementCard store="rio claro"/><EventCard title="Aniversários" tone="pink" events={birthdays}/></div><div className="space-y-4"><AnnouncementCard store="araras"/><EventCard title="Férias" tone="amber" events={vacations}/></div><MeetingSummaryCard araras={araras} rioClaro={rioClaro}/></section>:<section className="grid gap-4 lg:grid-cols-2"><AnnouncementCard store={panelStore}/><MeetingSummaryCard araras={panelStore==="araras"?araras:[]} rioClaro={panelStore==="rio claro"?rioClaro:[]}/><EventCard title="Aniversários" tone="pink" events={birthdays}/><EventCard title="Férias" tone="amber" events={vacations}/></section>}
