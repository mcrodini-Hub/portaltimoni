...
function applyRules(){const root=document.querySelector("main");if(!root)return;hideExplanatoryText(root);forceGeneralView(root);configureStockCards(root);configureMeetingCards(root)}
